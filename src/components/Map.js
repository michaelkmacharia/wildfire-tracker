...
const Map = ( ( { eventData , center , zoom } ) =>
	{
		...
		return ( <div className="map"> <GoogleMapReact bootstrapURLKeys={{ key: `` }} defaultCenter={ center } defaultZoom={ zoom }> { markers } </GoogleMapReact> { locationInfo && <LocationInfoBox info={ locationInfo } /> } </div> ) ;
	}
) ;
